...
<display:column headerClass="bluebgheadtd" class="blueborderfortd" title="Amount (ZK)" property="totalAmount" style="width:8%; text-align: right" format="{0, number, #,##0.00}" />
