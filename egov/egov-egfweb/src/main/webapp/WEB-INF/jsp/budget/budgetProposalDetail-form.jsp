...
<script>
	...
	function updateYearHeader(){
		...
		if(document.getElementById('yui-dt0-th-re_amount-liner')){
			document.getElementById('yui-dt0-th-re_amount-liner').innerHTML = '<span class="yui-dt-label">RE Amount(ZK)<br/>'+newCurrent+'<span class="mandatory1">*</span></span>';
		}
		if(document.getElementById('yui-dt0-th-amount-liner')){
			document.getElementById('yui-dt0-th-amount-liner').innerHTML = '<span class="yui-dt-label">BE Amount(ZK)<br/>'+newNext+'<span class="mandatory1">*</span></span>';
		}
