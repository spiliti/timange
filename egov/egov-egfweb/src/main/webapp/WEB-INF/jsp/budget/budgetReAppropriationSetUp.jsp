...
function createAmountFieldFormatter(values,prefix,suffix){
	...
	var makeBudgetDetailTable = function() {
		var budgetDetailColumns = [ 
			...
			{key:"approved",label:'Sanctioned<br/>Budget(ZK)',width:120, formatter:createAmountFieldFormatter(approvedAmountList,BUDGETDETAILLIST,".approvedAmount")},
			{key:"appropriated",label:'Added/Released<br/>(ZK)',width:120, formatter:createAmountFieldFormatter(appropriatedAmountList,BUDGETDETAILLIST,".appropriatedAmount")},
			{key:"planningBudgetApproved",label:'Planning Budget<br/> Approved(ZK)',width:"50em", formatter:createAmountFieldFormatter(planningBudgetApprovedList,BUDGETDETAILLIST,".planningBudgetApproved")},
			{key:"actuals",label:'Expenditure <br/>Incurred(ZK)',width:120, formatter:createAmountFieldFormatter(actualsList,BUDGETDETAILLIST,".actuals")},
			{key:"planningBudgetUsage",label:'Planning Budget<br/>Usage(ZK)',width:"50em", formatter:createAmountFieldFormatter(planningBudgetUsageList,BUDGETDETAILLIST,".planningBudgetUsage")},
			{key:"available",label:'Balance Fund <br/>Available(ZK)',width:120, formatter:createAmountFieldFormatter(availableList,BUDGETDETAILLIST,".availableAmount")},
			{key:"planningBudgetAvailable",label:'Planning Budget<br/>Available(ZK)',width:"50em", formatter:createAmountFieldFormatter(planningBudgetAvailableList,BUDGETDETAILLIST,".planningBudgetAvailable")},
			{key:"anticipatoryAmount",label:'Anticipated<br/>Expenditure(ZK)',width:120, formatter:createTextFieldFormatter(BUDGETDETAILLIST,".anticipatoryAmount")},
			...
			{key:"amount",label:'Addition of <br/>Funds sought(ZK)',width:"50em", formatter:createTextFieldFormatterWithOnBlur('budgetDetailsTable',BUDGETDETAILLIST,".deltaAmount")},
			{key:"total_available",label:'Budget Provision avail<br/> after Additional Appropriation(ZK)',width:"50em", formatter:createAmountFieldFormatter(actualsList,BUDGETDETAILLIST,".remainingAmount")},
			{key:"newPlanningBudgetAvailable",label:'New Planning Budget<br/> Available(ZK)',width:"50em", formatter:createAmountFieldFormatter(planningBudgetAvailableList,BUDGETDETAILLIST,".newPlanningBudgetAvailable")},
